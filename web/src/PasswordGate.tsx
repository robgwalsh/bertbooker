 ...
 * agreed the shared password was given (`workers/api/src/gate.ts`).
 *
 ...
 * (`workers/api/src/gate.ts`); what `session` tracks here is only whether we
 ...
 * remove, and it would be invisible. See `workers/api/src/gate.ts`.
 */
    ...
    <Centered>
      <Alert severity="warning" sx={{ maxWidth: 520 }}>
        ...
        <Typography variant="body2">
          Set <code>{name}</code> — a line in <code>workers/api/.dev.vars</code> locally, or{" "}
