 ...
 *
 * Keyed by IATA because that is what every source in this app speaks: seats.aero,
 * PointsYeah and the airline adapters all put a two-character code in
 * `Segment.carrier`.
 *
...
export const AIRLINE_ICAO: Record<string, string> = {
  // ---- mirrors AIRLINE_SEEDS (packages/core/src/data/airlines.ts) ----
  AC: "ACA", // Air Canada
