...
import { PRIMARY_METERED_SOURCE } from "../QuotaIndicator";
...
/**
 * Route-planning constants, hand-mirrored from `shared/src/routing.ts`
 * and `providers/seatsaero.ts`.
 *
 * Copied rather than imported because the SPA imports nothing from `shared/` —
 ...
 * Mirrors `SourceTaskStatus` in shared/src/ingest/types.ts.
 */
