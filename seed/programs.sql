...
INSERT OR REPLACE INTO programs (code, name, kind, alliance, transfer_partners, is_active) VALUES
  ('aeroplan',       'Air Canada Aeroplan',            'airline', 'star',     '[{"currency":"chase_ur","ratio":"1:1"},{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ('lifemiles',      'Avianca LifeMiles',              'airline', 'star',     '[{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ...
  -- Amex only. The others reach ANA through partner bookings, not a transfer.
  ('ana',            'ANA Mileage Club',               'airline', 'star',     '[{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ('singapore',      'Singapore KrisFlyer',            'airline', 'star',     '[{"currency":"chase_ur","ratio":"1:1"},{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ('flyingblue',     'Air France/KLM Flying Blue',     'airline', 'skyteam',  '[{"currency":"chase_ur","ratio":"1:1"},{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  -- Amex only: Delta takes no other transfer partner.
  ('skymiles',       'Delta SkyMiles',                 'airline', 'skyteam',  '[{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ...
  ('jetblue',        'JetBlue TrueBlue',               'airline', NULL,       '[{"currency":"chase_ur","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"5:4"}]', 1),
  ('qantas',         'Qantas Frequent Flyer',          'airline', 'oneworld', '[{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ('emirates',       'Emirates Skywards',              'airline', NULL,       '[{"currency":"chase_ur","ratio":"1:1"},{"currency":"capital_one","ratio":"1:1"},{"currency":"bilt","ratio":"1:1"},{"currency":"citi_ty","ratio":"1:1"},{"currency":"amex_mr","ratio":"5:4"}]', 1),
  ...
  ('marriott',       'Marriott Bonvoy',                'hotel',   NULL,       '[{"currency":"bilt","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1),
  ...
  ('choice',         'Choice Privileges',              'hotel',   NULL,       '[{"currency":"citi_ty","ratio":"1:1"},{"currency":"capital_one","ratio":"1:1"},{"currency":"amex_mr","ratio":"1:1"}]', 1);
