 ...
 *
 * Lives here rather than in the local runner because both callers need it and
 * must agree: the local runner classifying a source's throw, and `workers/api`'s
 * search endpoint classifying a seats.aero throw. Whatever this returns decides
