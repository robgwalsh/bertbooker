 ...
 *
 * `flightNumber` is not normalized across sources: PointsYeah returns it
 * carrier-prefixed ("AA4457") while the airline adapters return bare digits
 ...
 * couple holds.
 *
 * Mirrors `bestPointsForCash` in packages/core/src/data/programs.ts, but reads
...
// page (from PointsYeah's detail feed) when we have it, else a Google Flights
