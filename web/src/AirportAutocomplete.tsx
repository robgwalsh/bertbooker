...
import { countryName, flagEmoji } from "./ui";

// Local debounce so the async lookup fires on pause, not on every keystroke.
...
export function AirportMultiAutocomplete({
   ...
   *  see MAX_ORIGINS in packages/core/src/routing.ts. */
  max: number;
  placeholder?: string;
  helperText?: string;
  sx?: object;
   ...
   *  case — see `focusRef` in pages/Routes.tsx. */
